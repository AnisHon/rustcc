use crate::errors::parser::decl_error::DeclError;
...
generate_from!(ParserError, DeclError, Decl, ExpectError, Expect,);
...
impl ExpectError {
    pub fn expect(expect: String, span: Span) -> Self {
        Self {
            expect,
            found: None,
            span,
    ...
    pub fn expect_but_found(expect: String, found: String, span: Span) -> Self {
        Self {
            expect,
            found: Some(found),
            span,
...
generate_from!(ParserWarning, DeclWarning, Decl,);
//
// #[derive(Error, Debug)]
// pub enum ErrorKind {
...
//         let kind = ErrorKind::TypeError { errors: error };
//         Self::new(kind, span)
//     }
// }
//
