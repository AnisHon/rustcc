use crate::{constant::typ::CHAR_BITWIDTH, util::ap_int::APInt};
use crate::parser::comp_ctx::CompCtx;
use crate::types::parser::ast::{exprs::{Constant, ExprKind, UnaryOpKind}, ExprKey, TypeKey};
...
fn make_size(ctx: &CompCtx, sz: usize, result_ty: TypeKey) -> Constant {
    ...
    Constant::Integer { value: APInt::new(*signed, bits, value) }
}
    ...
    match value {
        Constant::Float { value } => {
            match op {
                ...
                Not => Constant::Integer { value: APInt::from_bool(!value.as_bool()) },
        ...
        Constant::Integer { value }  => {
             match op {
                Plus => Constant::Integer { value }, // 完全不用变
                Minus => Constant::Integer { value: value.neg() },
                Not => Constant::Integer { value: APInt::from_bool(!value.as_bool()) },
                BitNot =>  Constant::Integer { value: value.bitnot() }, // type检查后应该不会出现
                _ => return None,
            } 
        }
        // 能支持一个*运算符
        Constant::String { value } => {
            match op {
                Deref => Constant::Integer { value: APInt::new(true, CHAR_BITWIDTH, value[u8]) },
                _ => return None,
            }
        }
    }
